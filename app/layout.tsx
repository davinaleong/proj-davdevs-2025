...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body
        className={`${montserrat.variable} ${sourceCodePro.variable} font-sans antialiased min-h-screen font-medium text-black bg-white dark:bg-black dark:text-white print:text-black print:bg-white`}
      >
        <ClientLayout>
          {children}
        </ClientLayout>
