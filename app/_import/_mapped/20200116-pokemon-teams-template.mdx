...
description: "HTML Template - The template portion of a Pokemon-Teams React-app with CSS Grid and Flexbox"
date: "2020-01-16"
author: "Davina Leong"
tags: ["html", "template", "pokemon", "css-grid"]
featured: false
readingTime: 2
published: true
images: [{ src: "/projects/20200116-001-pokemon-teams-template.png", alt: "Pokemon Teams Template" }]
links:
  [
    {
      label: "See Demo",
