...
slug: "20220816-three-column-card"
description: "A Frontend Mentor challenge solution - A responsive 3-column card layout showcasing different vehicle types with clean design."
date: "2022-08-16"
author: "Davina Leong"
tags:
  [
...
readingTime: 3
published: true
images: [{ src: "/fem/fem-3-column-preview-card-component.png", alt: "3-Column Preview Card Component" }]
links:
  [
    {
      label: "Demo",
