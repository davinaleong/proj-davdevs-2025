...
description: "Astro App - My portfolio website showcasing web development projects and technical skills"
date: "2020-01-16"
author: "Davina Leong"
tags: ["astro", "portfolio", "website", "gatsby"]
featured: true
readingTime: 4
published: true
images: [{ src: "/projects/20200116-001-dav-devs.png", alt: "Dav/Devs" }]
links:
  [
    { label: "See Demo", href: "https://davina-devs.com/" },
    {
      label: "See Repo",
