...
description: "A step-by-step tutorial for building a functional calculator in Python with basic arithmetic operations and user input handling."
date: "2025-05-02"
author: "Davina Leong"
...
This Jupyter Notebook builds a simple calculator in Python using arithmetic
```python
