...
description: HTML template prototype for Pokemon team builder app
date: '2020-01-16'
author: Davina Leong
tags:
  - html
...
published: true
images:
  - src: /projects/20200116-001-pokemon-teams-template.png
    alt: Pokemon Teams Template
links:
  - label: See Demo
    href: 'https://davinaleong.github.io/proj-pokemon-teams-template/'
  - label: See Repo
    href: 'https://github.com/davinaleong/proj-pokemon-teams-template'
