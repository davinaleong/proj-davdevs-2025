...
description: >-
  Join my real-world journey of learning to work with OpenAI API! From broken
  code and misleading tutorials to finally getting it right, discover the setup
  tips, learning notes, and working JavaScript code that actually works.
date: '2024-01-02'
author: Davina Leong
tags:
  - openai
...
published: true
images:
  - src: 20240102-0001-tinkering-w-ai.jpg
    alt: Tinkering with OpenAI API
links: []
url: ''
---
