...
description: "Discover how I integrated an AI chatbot into my Dav/Devs website using Azure Search, Azure OpenAI, and GitHub Actions. A comprehensive guide to building an intelligent assistant that can extract and respond with site-specific information."
date: "2025-12-24"
author: "Davina Leong"
tags: ["ai-chatbot", "azure-search", "azure-openai", "github-actions", "embeddings", "chatgpt", "github-copilot", "web-development", "automation"]
featured: true
readingTime: 5
published: true
images: [
  { src: "20251224-0001-ai-chatbot-integration.png", alt: "AI Chatbot Integration on Dav/Devs" }
]
links: []
url: ""
---
