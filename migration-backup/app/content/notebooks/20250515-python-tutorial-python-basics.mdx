...
description: "A beginner-friendly Python tutorial covering core language fundamentals such as variables, data types, input, and basic operations."
date: "2025-05-15"
author: "Davina Leong"
tags:
  [
...
4. Using `input()` to accept user data
5. Printing output clearly
...
> then learn what to build with it.
